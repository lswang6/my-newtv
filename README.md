...
- 频道列表打开后按上下键焦点不动、按 OK 无法换台（v2.1.0 引入，v2.1.2 修复）
- 频道台标缓存产生 0 字节坏文件导致大量解码报错（v2.1.0 修复）
- 简繁混排、按 HOME 离开后再回来面板残留（v2.1.0 修复）
- 移除播放"无信号"广告垫片的失效频道：纬来体育、足球频道、精品体育（v2.1.2 / v2.1.3）
...
- 移除频道：足球频道、精品体育。它们的 epg.pw 地址在源站离线时会播放一段带二维码广告的"无信号"垫片。
